...
def ask_to_zekai(headers: Dict[str, str], post: InstagramPost) -> None:
...
def bulk_ask_to_zekai(post_data: List[InstagramPost]):
    ...
    for post in post_data:
        thread = thread_pool.submit(ask_to_zekai, headers=headers, post=post)
